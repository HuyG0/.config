...
# This file used on waybar modules sourcing defaults set in $HOME/.config/hypr/scripts/01-UserDefaults.conf

# Define the path to the config file
config_file=$HOME/.config/hypr/scripts/01-UserDefaults.conf
